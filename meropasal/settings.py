"""
Django settings for meropasal project.
...
SECRET_KEY = 'django-insecure-#d3(vak@@9%@z77r+0m0=blt4*s57-dh7zpxrydyg#@oh#n=p-'
...
WSGI_APPLICATION = 'meropasal.wsgi.application'
